...
class MainCommandLongKick: public MainCommand
{
private:
    double M_power;
    double M_dir;
public:
    MainCommandLongKick(double power, double dir)
    {
        M_type = MainCommand::MC_LONG_KICK;
        M_power = power;
        M_dir = dir;
    }
...
private:
    ...
    void apply_dash( double power, double dir );
    void turn( double moment ) override;
    void apply_turn( double moment );
    ...
    void apply_kick( double power, double dir );
    void long_kick( double power, double dir ) override;
    void apply_long_kick( double power, double dir );
    void goalieCatch( double dir ) override;
    void apply_goalieCatch( double dir );
    ...
    void apply_move( double x, double y );
    ...
    void apply_tackle( double power_or_angle, bool foul );
